#!/usr/bin/env python3
"""Generate Adobe Illustrator-compatible SVG version of the UBCA attention mask."""
...
# Configure matplotlib for better SVG compatibility with Illustrator
matplotlib.rcParams['svg.fonttype'] = 'none'  # Don't convert fonts to paths
...
plt.savefig(f"{out_dir}/ubca_mask_ai.svg", format='svg', bbox_inches="tight", pad_inches=0.12)
print("Saved: figures/ubca_mask_ai.svg (Adobe Illustrator compatible)")

#!/usr/bin/env python3
"""Generate a compact block-level attention mask figure for 4DW-VLA."""
...
plt.savefig(f"{out_dir}/ubca_mask.pdf", bbox_inches="tight", pad_inches=0.12)
plt.savefig(f"{out_dir}/ubca_mask.png", bbox_inches="tight", pad_inches=0.12, dpi=300)
print("Saved: figures/ubca_mask.pdf and figures/ubca_mask.png")
